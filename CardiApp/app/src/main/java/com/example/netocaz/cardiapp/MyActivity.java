...
public class MyActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ENTER_DATA_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            databaseHelper.insertData(data.getExtras().getString("tag_person_name"), data.getExtras().getString("tag_person_pin"), data.getExtras().getString("tag_person_pindos"), data.getExtras().getString("tag_person_pintres"));
